...
export declare function updateRootEsLintConfig(tree: Tree, existingEsLintConfig: any | undefined): void;
...
export declare function getWorkspaceCapabilities(tree: Tree, projects: WorkspaceProjects): WorkspaceCapabilities;
