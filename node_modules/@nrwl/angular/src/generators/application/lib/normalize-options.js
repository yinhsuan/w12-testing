...
function normalizeOptions(host, options) {
    ...
    const appDirectory = (0, project_1.normalizeDirectory)(options.name, options.directory);
    let e2eProjectName = `${(0, devkit_2.names)(options.name).fileName}-e2e`;
    const appProjectName = (0, project_1.normalizeProjectName)(options.name, options.directory);
